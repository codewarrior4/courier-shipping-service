...
<html>
    <head>
        <title>EMG - Shipping Services | Contact Us</title>
        <meta charset="UTF-8">
                        ...
                        <div class="row">
                            <div class="col-sm-8 pull-left">
                                <div class="title-wrap">
                                    <h2 class="section-title no-margin">Contact</h2>
                ...
                <section class="pad-50 about-wrap">
                    ...
                    <div class="container">
                        <section class="pad-30 more-about-wrap">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 wow fadeIn" data-wow-offset="50" data-wow-delay=".20s">
                                    <div class="jumbotron">
                                        <h4 class="display-4">Office Address</h4>
                                        <p class="lead"><span class="fas fa-address-book"></span> 63 Olorunsogo, Abeokuta <br> Ogun State. <br> Nigeria.</p>
                                        <hr class="my-4">
                                        <h4 class="display-4">Social Media Links</h4>
                                        <ul class="social-icons list-inline">
                                            <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".20s"> <a href="https://wa.me/2349077078473" class="fa fa-whatsapp"></a> </li>
                                            <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".25s"> <a href="https://wa.me/2348148148490" class="fa fa-whatsapp"></a> </li>
                                            <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".30s"> <a href="mailto:eniolamelodyshipping@gmail.com" class="fa fa-google-plus"></a> </li> 
                                        </ul>
                                        <p>Email <a href="mailto:admin@emgss.net">admin@emgss.net</a></p>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 wow fadeIn" data-wow-offset="50" data-wow-delay=".20s">
                                    <div class="jumbotron">
                                        <h3 class="display-4">Send Us a message</h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mt-3">
                                                    <textarea class="form-control" rows="3" placeholder="Message" name="message" style="resize:none"></textarea>
                                                    <!--<input class="form-control" type="text" placeholder="message">-->
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                            <button type="submit" name="mail" class="btn btn-primary mt-3 mb-3 text-white border-0 py-2 px-3"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 wow fadeIn" data-wow-offset="50" data-wow-delay=".20s">
