<?php
...

    {
        ...
        {
            echo json_encode(array("statusCode"=>200,"pname"=>$row['pname'],"plocation"=>$row['plocation'],"pfrom"=>$row['pfrom'],"pdestination"=>$row['pdestination'],"pweight"=>$row['weight'],"expected"=>$row['expected'],"status"=>$row['pstatus'],"sname"=>$row['sname'],"semail"=>$row['semail'],"sphone"=>$row['sphone'],"rname"=>$row['rname'],"rphone"=>$row['rphone'],"remail"=>$row['remail'],"created"=>$row['created'])); 
        }  
        else
        {
