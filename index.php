            ...
            <article> 
                ...
                <section class="banner mask-overlay pad-120 white-clr">
                    <div class="container theme-container rel-div">
                        ...
                        <h2 class="section-title fs-48 effect animated wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s"> Cheapest way to <br> <span class="theme-clr">ship to </span> Nigeria <span class="theme-clr"> from USA </span>  </h2>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-11 col-md-offset-1">
                                <div class="pt-120 rel-div">
                                    ...
                                    <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">This service offers the <br> cheapest way to ship to Nigeria from the USA, <br> with a delivery time of 7 - 10 business days</p>
