...
<html>
    <head>
        <title>EMG Shipping Services</title>
        <meta charset="UTF-8">
            ...
            <article> 
                ...
                <section class="banner mask-overlay pad-120 white-clr">
                    <div class="container theme-container rel-div">
                        <!-- <img class="pt-10 effect animated fadeInLeft" alt="" src="assets/img/logo/image3.jpeg"/> -->
                        <ul class="list-items fw-600 effect animated wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">   
                            <li><a href="#">Fast</a></li>
                            <li><a href="#">Secured</a></li>
                            <li><a href="#">Worldwide</a></li>
                        </ul>
                        <h2 class="section-title fs-48 effect animated wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s"> Cheapest way to <br> <span class="theme-clr">ship to Nigeria</span>  from anywhere <span class="theme-clr">  in the world </span>  </h2>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-us">
                                    ...
                                    <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">EMG Shipping service provides a portfolio of full logistic solutions in Nigeria which includes, but not limited to International and Domestic express delivery, Freight Forwarding, Integrated Logistics Solutions, Information and Document Management Solutions, Warehousing, Packaging Services.</p>
                                    <ul class="feature">
                                        <li> 
                                            ...
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                                ...
                                                <p>We guarantee on time delivery from anywhere in the world to Nigeria within 7 - 10 days.</p>                                            
                                            </div>  
                                        </li>
                                        <li> 
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                ...
                                <div class="steps-content wow fadeInLeft" data-wow-offset="50" data-wow-delay=".25s"> 
                                    <h2 class="title-3">Give us your product</h2> 
                                    <p class="gray-clr">Provide us the goods and services you want to ship  </p>                                            
                                </div>  
                            </div>
                            <div class="col-md-3 col-sm-6">
                                ...
                                <div class="steps-content wow fadeInLeft" data-wow-offset="50" data-wow-delay=".25s"> 
                                    ...
                                    <p class="gray-clr">Stay calm for your products to <br> be delivered within 7 - 10 days</p>                                            
                                </div>  
                            </div>
                            <div class="col-md-3 col-sm-6">
                                ...
                                <div class="steps-content wow fadeInLeft" data-wow-offset="50" data-wow-delay=".25s"> 
                                    ...
                                    <p class="gray-clr">Your products are ready to be delivered once they get here.</p>                                            
                                </div>  
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-11 col-md-offset-1">
                                <div class="pt-120 rel-div">
                                    ...
                                    <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">This service offers the <br> cheapest way to ship to Nigeria from anywhere in the world, <br> with a delivery time of 7 - 10 business days</p>
                            ...
                            <div class="item">
                                ...
                                <div class="testimonial-content">
                                    <p class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">  <i class="gray-clr fs-16">
                                            Having used EMG shipping services for over two years, they have always offered a flexible and professional service for transport and storage needs
                                        </i> </p>
                                    <h2 class="title-2 pt-10 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s"> <a href="#" class="white-clr fw-900"> Eniola Melody </a> </h2>
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="testimonial-content">
                                    <p >  <i class="gray-clr fs-16">
                                            EMG shipping services are a very reliable and professional haulage company who are always ready to assist you with all your transport needs and requirements.”
                                        </i> </p>
                                    <h2 class="title-2 pt-10"> <a href="#" class="white-clr fw-900"> Ogunsemowo Samuel </a> </h2>
                                </div>
                            </div>
                            <div class="item">
                                <div class="testimonial-img darkclr-border theme-clr font-2">
                                ...
                                <div class="testimonial-content">
                                    <p>  <i class="gray-clr fs-16">
                                            I would like to take this opportunity to express my satisfaction on the level of service that EMG shipping services provide. We have utilised their services for over 2 years… 
                                            During  this time we have found the team at EMG shipping services to run an efficient and extremely well organised operation.
                                        </i> </p>
                                    <h2 class="title-2 pt-10"> <a href="#" class="white-clr fw-900">  </a> </h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row ">
                            <div class="col-md-6 col-sm-12 mb-3">
                                ...
                                <ul class="contact-detail title-2">
                                    ...
                                    <li class="wow slideInUp" data-wow-offset="50" data-wow-delay=".30s"> <span>Email address:</span> <br> <a href="mailto:eniolamelodyshipping@gmail.com" class="gray-clr"> eniolamelodyshipping@gmail.com </a> <br> <a href="mailto:admin@emgss.net" class="gray-clr"> admin@emgss.net </a></li>
                            ...
                            <div class="col-sm-12 col-md-6 mb-3">
                                <form action="sendmail.php" method="post">
                                    <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mt-3">
                                                    <textarea class="form-control" rows="5" placeholder="Message" name="message" style="resize:none"></textarea>
                                                    <!--<input class="form-control" type="text" placeholder="message">-->
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                            <button type="mail" class="btn btn-primary mt-3 mb-3 text-white border-0 py-2 px-3"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                                            </div>
                                        </div>
                                </form>
                            </div>                      
