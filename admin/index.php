							...
							<div class="t-header">No Search Field</div>
								...
								while($row_contact=mysqli_fetch_array($contact))
								{
									...
									<tr>
										...
										<td>
										<?php 
											if($row_contact['pstatus']=="Shipment information sent to Emgss" || $row_contact['pstatus']=="Picked up")
											{
												echo '<span class="badge badge-pill badge-dark">'.$row_contact['pstatus'].'</span>';
											}  
											elseif($row_contact['pstatus']=="At local emgss facility" || $row_contact['pstatus']=="Left emgss origin facility" || $row_contact['pstatus']=="In transit" || $row_contact['pstatus']=="On Emgss vehicle for delivery" || $row_contact['pstatus']=="Clearance delay (International orders)")
											{
												echo '<span class="badge badge-pill badge-warning">'.$row_contact['pstatus'].'</span>';

											}
											elseif($row_contact['pstatus']=="Customer not available or business closed (For more information, please contact Emgss customer service.)" || $row_contact['pstatus']=="Business closed - No delivery attempt (For more information, please contact Emgss customer service.)" || $row_contact['pstatus']==" Customs delay (For more information, please contact Emgss customer service.)" || $row_contact['pstatus']=="Holiday (For more information, please contact Emgss customer service.)" || $row_contact['pstatus']=="Missing documentation. (For more information, please contact Emgss customer service.)")
											{
												echo '<span class="badge badge-pill badge-danger">'.$row_contact['pstatus'].'</span>';

											}
											elseif($row_contact['pstatus']=="Delivered")
											{
												echo '<span class="badge badge-pill badge-success">'.$row_contact['pstatus'].'</span>';
