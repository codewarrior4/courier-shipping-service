                    ...
                    <div class="theme-container container ">  
                        ...
                        <div class="row" style="display:none" id="parent">
                            <div class="col-md-7 pad-30 wow fadeInLeft" data-wow-offset="50" data-wow-delay=".30s"> 
                                <img alt="" src="" id="pimage" />
                            </div>
                            <div class="col-md-5 pad-30 wow fadeInRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                <div class="prod-info white-clr">
                                    <ul>
                                        <li> <span class="title-2">Product Name:</span> <span class="fs-16" id="pname">iPhone 6 Boxed</span> </li>
                                        <li> <span class="title-2">order date:</span> <span class="fs-16" id="created">21st Feb, 2016</span> </li>
                                        <li> <span class="title-2">order status:</span> <span class="fs-16 theme-clr" id="status">On Process</span> </li>
                                        <li> <span class="title-2">weight (kg):</span> <span class="fs-16" id="weight">0.85 KG</span> </li>
                                        <li> <span class="title-2">Sender:</span> <span class="fs-16" id="sname">0.85 KG</span> </li>
                                        <li> <span class="title-2">Reciever:</span> <span class="fs-16" id="rname">0.85 KG</span> </li>
                                        
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="progress-wrap" style="display:none" id="parents">
                            ...
                            <div class="row progress-content upper-text">
                                <div class="col-md-3 col-xs-8 col-sm-2">
                                    ...
                                    <h2 class="title-1 no-margin" id="pfrom">London</h2>
                                </div>
                                ...
                                <div class="col-md-4 col-xs-8 col-sm-4 text-center">
                                    ...
                                    <h2 class="title-1 no-margin" id="plocation">singapore</h2>
                                </div>
                                <div class="col-md-1 col-xs-8 col-sm-1 no-pad">
                                    <p class="fs-12 no-margin"> To deliver by [ <b class="black-clr" id="expected"> </b> ] </p>                                
                                </div>
                                <div class="col-md-2 col-xs-8 col-sm-2 text-right">
                                    <p class="fs-12 no-margin"> to </p>
                                    <h2 class="title-1 no-margin" id="pdestination">dhaka</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
					...
					({
						...
						success: function(dataResult)
						{
							...
							if(dataResult.statusCode==200)
							{
                                ...
                                $("#parent").show()
                                $("#pimage").attr("src","admin/img/package/"+dataResult.pimage)
                                ...
                                $("#expected").html(dataResult.expected)
